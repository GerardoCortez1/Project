 ...
 * Created on February 10, 2023, 7:00 PM
 * Purpose:  Create a game with funcitons.
 */
...
int get_Dif_Time(time_t , time_t); // Get time difference in Integer - Function Overloading
...
string wish_luck(string playern){
    return "\t\t       Good luck " + playern + "!" + "\n";
}

// Overload Function
// 1st Function
int get_Dif_Time(time_t start, time_t end){
    int difTimI;
    difTimI = end - start;
    return difTimI;
}
